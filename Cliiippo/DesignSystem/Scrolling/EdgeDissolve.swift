...
/// Scroll-driven edge dissolve for content underlapping the palette's floating bars.
struct EdgeDissolveMask: ViewModifier {
    /// Band lengths include each bar's occupied height plus a soft overshoot into the list.
    ...
    private func stops(height: CGFloat) -> [Gradient.Stop] {
        ...
        // Midpoint alpha eases toward the floor as a full band of content scrolls past.
